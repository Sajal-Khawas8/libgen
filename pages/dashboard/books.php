        ...
        <?php foreach ($books as $book): ?>
            <li class="px-5 py-3 bg-white rounded-md relative">
                <?php if (isset($_COOKIE['deleteId']) && $_COOKIE['deleteId'] === $book['book_uuid']): ?>
                    <div class="absolute top-0 inset-x-0 bg-red-500 text-white py-1 px-3 text-center text-lg"><?= $_COOKIE['err'] ?>
                    </div>
                    ...
                    <div class="flex flex-col justify-evenly h-full ml-auto">
                        ...
                        <form action="/formHandler" method="post">
                            ...
                            <button type="button" onclick="document.getElementById('deleteModal').style.display='flex'"
                                ...
                                Book</button>
                            <div id="deleteModal" class="absolute inset-0 bg-gray-500/60 hidden flex-col justify-center items-center space-y-8">
                                <div class="flex gap-16 items-center">
                                    <p class="font-semibold text-3xl">Are you sure?</p>
                                    <button type="button" onclick="document.getElementById('deleteModal').style.display='none'" class=""
                                ...
                                <div class="flex gap-16 items-center w-72">
                                    <button name="deleteBook" class="flex-1 px-4 py-1 bg-white text-red-600 font-medium text-lg rounded-md hover:bg-red-600 hover:text-white">Yes</button>
                                    <button type="button" onclick="document.getElementById('deleteModal').style.display='none'" class="flex-1 px-4 py-1 bg-white text-black font-medium text-lg rounded-md">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
